...
public class Bankpay {
	 ...
	 * 页面跳转同步通知页面路径
	 */
	public final static String RETURN_URL = "http://www.fakafa.com/bankpay/return.jspx";
	/**
	 * 服务器异步通知页面路径
	 */
	public final static String NOTIFY_URL = "http://www.fakafa.com/bankpay/notify.jspx";
	...
	public String create(Order order, Payway payway, Payment payment) {
		...
		String body = order.getType() + order.getFace() + "元("
				...
				+ order.getSName() + ")";
		String defaultbank = payway.getCode();
		// 客户端IP
...
//		String sign_type = SIGN_TYPE;
		...
		sbuffer.append("&defaultbank=").append(defaultbank);
...
//		sbuffer.append("&need_ctu_check=").append(need_ctu_check);
